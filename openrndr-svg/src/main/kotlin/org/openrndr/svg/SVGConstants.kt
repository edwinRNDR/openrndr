...
internal object At {
    ...
    const val COLOR_RENDERING = "color-rendering"
    const val CX = "cx"
    const val CY = "cy"
    const val D = "d"
    ...
    const val HREF = "href"
    const val ID = "id"
    const val IMAGE_RENDERING = "image-rendering"
    ...
    const val TEXT_RENDERING = "text-rendering"
    const val TRANSFORM = "transform"
    const val VERSION = "version"
    const val VIEW_BOX = "viewBox"
    const val VIEWPORT_FILL = "viewport-fill"
    const val VIEWPORT_FILL_OPACITY = "viewport-fill-opacity"
